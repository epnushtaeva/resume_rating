                                                                                      ...
                                                                                      {{item.status}}
                                                                                        ...
                                                                                        <template v-slot:item.info="{item}">
                                                                                                                                                                  ...
                                                                                                                                                                  <span v-if="item.taskType=='Обучение нейронной сети' && item.specialityName!=null">Специальность: {{item.specialityName}}</span>
                                                                                                                                                                                                                                                      <span v-if="item.taskType=='Загрузка резюме из HeadHunter'">Страница с: {{item.pageFrom}}, количество страниц: {{item.pagesCount}}</span>
                                                                                                                                                                </template>
