...
public class StemmingPorter implements Porter {
    ...
    public List<String> portWords(List<String> words){
        List<String> result = new ArrayList<>();

        for(String word: words){
            String tempWord = this.portWord(word);
    ...
    public String portWord(String word) {
